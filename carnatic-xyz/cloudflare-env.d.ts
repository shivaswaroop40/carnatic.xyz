/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: df26f5aba021981abad0986c84e5f08a)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* carnatic-xyz */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_URL" | "NEXTJS_ENV">> {}
}
