...
export default function ShrutiPage() {
	...
	// When tone changes while playing, restart with new sound
	useEffect(() => {
		if (!playing) return;
		stop(true);
		start();
	}, [tone]); // eslint-disable-line react-hooks/exhaustive-deps -- only restart when tone changes
	...
	return (
		<div className="container mx-auto max-w-md py-8">
			...
			<p className="text-muted-foreground mb-6 text-sm">
				Choose a scale (tonic) and tone. The drone plays Pa (Mandra) · Sa (Madhya) · Sa (Tara).
			</p>
